ActionController::Routing::Routes.draw do |map|
  ...
  map.send_activation_mail 'send_activation_mail/:id', :controller => :users, :action => :send_activation_mail
  map.activate_user 'activate_user/:code', :controller => :users, :action => :activate, :code => ''
  ...
  map.change 'change_password/:recover', :controller => 'users', :action => "change_password"
  ...
  map.materials_by_letter 'materials_by_letter/:letter/:for', :controller => 'common', :action => 'materials_by_letter', :for => 'all'
